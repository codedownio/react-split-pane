      ...
      value: function render() {
        ...
        return /*#__PURE__*/ React__default['default'].createElement('span', {
          ...
          onMouseEnter: function onMouseEnter(event) {
            return _onMouseEnter && _onMouseEnter(event);
          },
          onMouseLeave: function onMouseLeave(event) {
            return _onMouseLeave && _onMouseLeave(event);
          },
...
Resizer.propTypes = {
  ...
  onMouseEnter: PropTypes__default['default'].func.isRequired,
  onMouseLeave: PropTypes__default['default'].func.isRequired,
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props4 = this.props,
            ...
            onResizerMouseEnter = _this$props4.onResizerMouseEnter,
            onResizerMouseLeave = _this$props4.onResizerMouseLeave,
...
SplitPane.propTypes = {
  ...
  onResizerMouseEnter: PropTypes__default['default'].func,
  onResizerMouseLeave: PropTypes__default['default'].func,
  style: stylePropType__default['default'],
